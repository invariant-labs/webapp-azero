...
import TransactionPriorityButton from '@components/Header/HeaderButton/TransactionPriorityButton/TransactionPriorityButton'
import AnimatedButton from '@components/common/AnimatedButton/AnimatedButton'
import { IPriorityFeeOptions } from '@containers/HeaderWrapper'
...
const Priority: React.FC<Props> = ({
  ...
  const [timerId, setTimerId] = useState<NodeJS.Timeout | string>('')
